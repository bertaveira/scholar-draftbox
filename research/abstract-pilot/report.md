# Abstract and arXiv metadata pilot

Dataset: `ae6392c8841f5e10`. Sample: 80 reproducibly random papers plus 20 short/non-ASCII/math-title challenge papers; seed 20260905. These are separate strata, not an unbiased 100-paper coverage estimate.

## Results

| Group | Papers | Clear matches | Review candidates | No results | Request failures |
|---|---:|---:|---:|---:|---:|
| random | 80 | 58 | 3 | 19 | 0 |
| challenge | 20 | 12 | 0 | 8 | 0 |

First pass: {'no_results': 29, 'clear': 70, 'review': 1}. After fallback: {'review': 3, 'clear': 70, 'no_results': 27}.
All 70 clear matches have arXiv URLs; 70 have nonempty abstracts.
...
## Pilot review and recommendation
